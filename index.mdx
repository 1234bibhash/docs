...
<Card title="FlowTask is not just another project management tool. Most tools are designed for people who love organizing. FlowTask is designed for people who hate "chasing."" color="#375bd8" horizontal={false}></Card>
