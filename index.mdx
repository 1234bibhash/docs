...
<Card title="Welcome to our documentation, where you can learn how to prompt PeopleGPT, use power filters, and improve your outreach." color="#375bd8" horizontal={false}>
